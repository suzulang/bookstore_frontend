  ...
  return (
        <div className="text-2xl space-x-2 flex justify-between mt-2 items-center">
             ...
             <div className="flex items-center space-x-2">
                ...
                <form onSubmit={editCountCart} className="join w-32">
                ...
                {books[bookExistsInCartFun(book)] && <span className="badge badge-lg text-white badge-success rounded">{books[bookExistsInCartFun(book)].cartCount}</span>}
